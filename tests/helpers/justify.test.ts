import justify from "../../src/helpers/justify";
...
describe('Should test justify function', () => {
    it('should justify the sentence with length', () => {
        expect(justify(bigSentence, 80)).to.equal("Longtemps, je me suis couchÃ© de bonne heure. Parfois, Ã peine ma bougie\n" +
    ...
    it('should return an empty string we the sentence is empty and the length is 150', () => {
        expect(justify("", 150)).to.be.equal("");
    });

    it('should justify the sentence without length', () => {
        expect(justify(smallSentence)).to.be.equal("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor\n" +
            "incididunt ut labore et dolore magna aliqua.");
    });

    it('should justify the sentence with a text length upper than length parameter', () => {
        expect(justify(smallSentence, 15)).to.be.equal("Lorem ipsum\n" +
            "dolor sit\n" +
            "amet,\n" +
            "consectetur\n" +
            "adipiscing\n" +
    ...
    it('should not justify anything with a word length upper than length parameter', () => {
        expect(justify(wordWithALongLength, 10)).to.be.equal(wordWithALongLength);
    });
